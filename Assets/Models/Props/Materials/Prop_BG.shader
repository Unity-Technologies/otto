...
Shader "Shader Forge/Prop_BG" {
    Properties {
        _Color ("Color", Color) = (1,1,1,1)
        _MainTex ("AO", 2D) = "white" {}
        _Color_Multiplier ("Color_Multiplier", Range(0, 2)) = 0.5
        _Color_Add ("Color_Add", Range(0, 1)) = 0.25
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
///////// Gloss:
                ...
                float gloss = 1.0 - _MainTex_var.r; // Convert roughness to gloss
                float perceptualRoughness = _MainTex_var.r;
...
////// Specular:
                ...
                float3 specularColor = i.vertexColor.r;
                float specularMonochrome;
                float3 diffuseColor = (((_MainTex_var.rgb*_Color_Multiplier)+_Color_Add)*_Color.rgb); // Need this for specular when using metallic
